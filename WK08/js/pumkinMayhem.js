...
function preload() {
    ...
    walkStrings = loadStrings("../textfiles/dead.txt");
}
...
function setup() {
    ...
    for (let k = 0; k < deadStrings.length; k++) {
        deadArray.push(new myImage(deadStrings[k], 50, 200, 680, 472));
    }

    objectToEat = new targetFood.js("../images/foodAnimation/Thunder.png", 500, 200, 100, 100);
